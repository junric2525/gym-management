...
<body>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            <ul>
                <li class="active"><a href="deleted_members_view.php"><i class="fas fa-history"></i> Membership Delete History</a></li> 
                <li><a href="deleted_subscription_view.php"><i class="fas fa-history"></i> Subscription Delete History</a></li>
            </ul>
        </aside>
        ...
        <main class="main-content"> 
            ...
            <div class="content-card">
                ...
                if (isset($_GET['status'])) {
                    ...
                    if ($status == 'restored') {
                        echo '<div class="alert alert-success"><i class="fas fa-check-circle"></i> Member successfully restored to the active list.</div>';
                    } elseif ($status == 'error') {
                        echo '<div class="alert alert-danger"><i class="fas fa-exclamation-triangle"></i> **Operation Failed!** Error: ' . $msg . '</div>';
                    }
                }
                ?>
                ...
                if ($result->num_rows > 0) {
                   ...
                   while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>
                            ...
                            <td>
                                <div class='action-buttons'>
                                    ...
                                    <form method='POST' action='../backend/process_member_permanent_delete.php'
                                    onsubmit='return confirm(\"⛔ WARNING! This will **PERMANENTLY DELETE** this archive entry for {$row['first_name']} {$row['last_name']}. Are you absolutely sure?\");' style=\"margin-top: 5px;\">
                    ...
                    echo "     <a href='membership_manage.php' class='btn-pending-link'><i class='fas fa-clipboard-list'></i> Check Membership Management</a>";
                    echo "</div>";
                }
                ?>
            </div> <?php $conn->close(); ?>
